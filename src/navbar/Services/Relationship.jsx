      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-[#CBA135]/50 hover:shadow-xl transition-shadow duration-300 dark:bg-[#4B3869]/80 dark:border-[#DDBEC3]/50">
          ...
          <p className="text-lg leading-relaxed mb-6 text-[#3E3E3E] dark:text-[#DACFBB]">
            Karuna Healing is an advanced form of Reiki that focuses on deep emotional and karmic healing. The word Karuna is Sanskrit for “compassionate action”—it goes beyond feeling empathy to taking action to relieve suffering. </p>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <ul className="list-disc list-inside space-y-2 text-[#3E3E3E] dark:text-[#DACFBB]">
                <li>Works on deeper emotional levels, including trauma, karmic wounds, inner child healing, and shadow aspects.
                </li>
                <li> Cellular healing
                </li>
                <li> Soul retrieval
              ...
              <ul className="list-disc list-inside space-y-2 text-[#3E3E3E] dark:text-[#DACFBB]">
                ...
                <li>Strong emphasis on compassion, forgiveness, and loving-kindness.
                </li>
                <li>	Breaking negative patterns
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-semibold text-[#4B3869] mb-4 dark:text-[#DDBEC3]">Benefits of Karuna Healing
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <ul className="list-disc list-inside space-y-2 text-[#3E3E3E] dark:text-[#DACFBB]">
                <li> Deep emotional cleansing and heart healing

                </li>
                <li> Healing ancestral and karmic wounds
</li>
